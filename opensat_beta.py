...
def scene_links():
    if args.bands == None:  #download all files
        if satellite == "landsat":
            tile_folder = ["_B1.TIF", "_B2.TIF", "_B3.TIF", "_B4.TIF.jp2", "_B5.TIF", "_B6.TIF", "_B7.TIF", "_B8.TIF", "_B9.TIF", "_B10.TIF", "_B11.TIF", "_BQA.TIF", "_MTL.txt"]
            for pic in tile_folder:
                urls.append("https://s3.amazonaws.com/geotrellis-sample-datasets/landsat/" + scene + pic)
        elif satellite == "sentinel":
            tile_folder = ["B01.jp2", "B02.jp2", "B03.jp2", "B04.jp2", "B05.jp2", "B06.jp2", "B07.jp2", "B08.jp2", "B09.jp2", "B10.jp2", "B11.jp2", "B12.jp2", "productInfo.json"]
            for pic in tile_folder:
        ...
        for band in bands:
            if satellite == "landsat":
                ...
                url = "http://sentinel-s2-l1c.s3.amazonaws.com/tiles/" + utm_code + "/" + lat_band + "/" + square + "/" + year + "/" + month + "/" + day + "/" + sequence + "/" + "B0" + band + ".jp2"
                urls.append(url)
